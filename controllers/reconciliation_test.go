...
func TestReconcile(t *testing.T) {
	...
	r.Client.(*mocks.MockClient).EXPECT().Get(gomock.Any(), types.NamespacedName{Namespace: "error", Name: ing.Name}, ing).
		Return(fmt.Errorf("random error")).AnyTimes()
	r.Client.(*mocks.MockClient).EXPECT().Get(gomock.Any(), types.NamespacedName{Namespace: "found", Name: ing.Name}, ing).
		Return(nil, ing.Name)).AnyTimes()
