...
func (p *EmptyDNSProvider) CreateZoneDelegationForExternalDNS(*rs.ReconciliationState) (err error) {
	return
}

func (p *EmptyDNSProvider) IngressExposedIPs(gslb *rs.ReconciliationState) (r []string, err error) {
...
func (p *EmptyDNSProvider) SaveDNSEndpoint(gslb *rs.ReconciliationState, i *externaldns.DNSEndpoint) error {
