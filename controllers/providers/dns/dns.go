...
type Provider interface {
	...
	CreateZoneDelegationForExternalDNS(*rs.ReconciliationState) error
	// IngressExposedIPs retrieves list of IP's exposed by all GSLB ingresses
	IngressExposedIPs(*rs.ReconciliationState) ([]string, error)
	...
	SaveDNSEndpoint(*rs.ReconciliationState, *externaldns.DNSEndpoint) error
