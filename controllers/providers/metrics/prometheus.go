...
func (m *PrometheusMetrics) IncrementError(rs *reconciliation.ReconciliationState) {
...
func (m *PrometheusMetrics) IncrementReconciliation(rs *reconciliation.ReconciliationState) {
...
func (m *PrometheusMetrics) InfobloxIncrementZoneUpdate(rs *reconciliation.ReconciliationState) {
...
func (m *PrometheusMetrics) InfobloxIncrementZoneUpdateError(rs *reconciliation.ReconciliationState) {
...
func (m *PrometheusMetrics) InfobloxIncrementHeartbeat(rs *reconciliation.ReconciliationState) {
...
func (m *PrometheusMetrics) InfobloxIncrementHeartbeatError(rs *reconciliation.ReconciliationState) {
