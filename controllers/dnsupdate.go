...
func (r *AnnoReconciler) gslbDNSEndpoint(rs *rs.ReconciliationState) (*externaldns.DNSEndpoint, error) {
...
func (r *AnnoReconciler) getLabels(rs *rs.ReconciliationState, targets assistant.Targets) (labels map[string]string) {
...
func (r *AnnoReconciler) updateRuntimeStatus(rs *rs.ReconciliationState, isPrimary bool, isHealthy status.HealthStatus, finalTargets []string) {
	switch rs.Spec.Type {
