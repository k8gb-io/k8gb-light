...
func (m *MockProvider) CreateZoneDelegationForExternalDNS(arg0 *reconciliation.LoopState) error {
	m.ctrl.T.Helper()
...
func (m *MockProvider) IngressExposedIPs(arg0 *reconciliation.LoopState) ([]string, error) {
	m.ctrl.T.Helper()
...
func (m *MockProvider) SaveDNSEndpoint(arg0 *reconciliation.LoopState, arg1 *endpoint.DNSEndpoint) error {
	m.ctrl.T.Helper()
