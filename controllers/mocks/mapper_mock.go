...
func (m *MockMapper) Get(arg0 types.NamespacedName) (*reconciliation.LoopState, reconciliation.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0)
	ret0, _ := ret[0].(*reconciliation.LoopState)
	ret1, _ := ret[1].(reconciliation.Result)
	ret2, _ := ret[2].(error)
...
func (m *MockMapper) TryInjectFinalizer(arg0 *reconciliation.LoopState) (reconciliation.Result, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TryInjectFinalizer", arg0)
	ret0, _ := ret[0].(reconciliation.Result)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockMapper) TryRemoveFinalizer(arg0 *reconciliation.LoopState, arg1 func(*reconciliation.LoopState) error) (reconciliation.Result, error) {
	m.ctrl.T.Helper()
