...
func (r *AnnoReconciler) updateStatus(rs *rs.ReconciliationState, ep *externaldns.DNSEndpoint) error {

	// TODO: goes to ingress  annogtations
	m.UpdateIngressHostsPerStatusMetric(rs, gslb.Status.ServiceHealth)

	// TODO: goes to ingress  annogtations
	m.UpdateHealthyRecordsMetric(rs, gslb.Status.HealthyRecords)

	m.UpdateEndpointStatus(ep)

	// todo: save back to ingress
